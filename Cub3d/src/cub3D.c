...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/29 18:04:54 by ocastell          #+#    #+#             */
/*   Updated: 2023/04/29 21:02:51 by mgirardi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/cub3d.h"

void	ft_init_struct(t_ncul *data)
{
...
char	*ft_init_game(t_ncul *data, int ac, char **av)
{
	char	*str;
